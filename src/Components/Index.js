    ...
    return (
        <div>
            ...
            <section className="pb-5">
                <div className="container pb-5 mb-5" id='faq'>
                            ...
                            <div className="accordion text-white bg-transparent" role="tablist" id="accordion-1">
                                <div className="accordion-item bg-transparent border-0 ">
                                    ...
                                    <div className="accordion-collapse  collapse show item-1" role="tabpanel" data-bs-parent="#accordion-1">
                                        <div className="accordion-body text-white">
                                            <p>
                                                Решението на всичките Ви проблеми!<br />
                                                Шегуваме се.<br />
                                                В кутията има 26 карти, които сме рисували поне 6 месеца. Не се и съмняванме, че сте интелигентни,
                                                но все пак сме сложили и една карта с инструкции, за всеки случай. И понеже сме готини, ви подаряваме
                                                и стикерче, с което да си украсите икейската лампа.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="accordion-item bg-transparent border-0">
                                    ...
                                    <div className="accordion-collapse collapse item-2" role="tabpanel" data-bs-parent="#accordion-1">
                                        <div className="accordion-body text-white">
                                            <p className="mb-0">
                                                Много е проста. Покрили сме всяка потенциална чуденка с 6те ни рунда, тъй
                                                като всички знаем, че стане ли въпрос за вземане на решение, ник'ви ги няма.<br />
                                                На всеки рунд, маникюристът подава картите с гръб към клиента, той тегли, маникюристът
                                                изпълнява - и туй то.
                                                <br />
                                                <br />
                                                Единсвената тънкост е в Рунд 3 Дизайн - Ако клиентът изтегли карта "С декорация" се играе
                                                Рунд 4 Декорация, ако изтегли "изчистени" пропускате и продължавате към Рунд 5 Цвят.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="accordion-item bg-transparent border-0">
                                    <h2 className="accordion-header bg-transparent text-white" role="tab">
                                        <button className="accordion-button collapsed bg-transparent text-white fm-l" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-3" aria-expanded="false" aria-controls="accordion-1 .item-3">Ама аз нямам време да се занимавам с френски и подобни... к'во да правя?</button>
                                    </h2>
                                    <div className="accordion-collapse collapse item-3" role="tabpanel" data-bs-parent="#accordion-1">
                                        <div className="accordion-body text-white">
                                            <p className="mb-0 ">
                                                Щом нямаш време, махаш картите, с които не ти се занимава, от тестето, все едно
                                                никога не ги е имало и  играеш.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='accordion-item bg-transparent border-0'>
                                    <h2 className='accordion-header bg-transparent text-white' role='tab'>
                                        <button className="accordion-button collapsed bg-transparent text-white fm-l" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-5" aria-expanded="false" aria-controls="accordion-1 .item-5">Ще има ли и други карти?</button>
                                    </h2>
                                    <div className='accordion-collapse collapse item-5' role='tabpanel' data-bs-parent="#accordion-1">
                                        <div className='accordion-body text-white'>
                                            <p className='mb-0'>
                                                Съвсем скоро ще избухнем със следващата ни колекция. Последвайте ни, за да не изпуснете <i class="fa-regular fa-face-smile-wink"></i>.
                                            </p>
                                        </div>
                                    </div>
