                    ...
                    <div className={`col text-center ${selectedImage === box ? '' : 'small-image'}`}>
                        ...
                        <div className="row justify-content-center mb-4">
                            <div className="col-3 text-center br mx-1 py-1">
                                <img src={box} height='80' onClick={() => handleImageClick(box)} />
                            </div>
                            <div className="col-3 text-center br mx-1 py-1">
                                <img src={img2} height='80' onClick={() => handleImageClick(img2)} />
                            </div>
                            <div className="col-3 text-center mx-1 py-1">
                                <img src={img3} height='80' onClick={() => handleImageClick(img3)} />
                            </div>
                        </div>
                    </div>
                    <div class="col mx-5">
