...
const Cart = () => {
    ...
    const Push = (event) => {
        ...
        shipioRepository.createOrder({
            ...
            .then(() => {
                emailSenderRepository.sendNewOrderEmail(name).catch((error) => console.log(error));
    ...
    const isItem = () => {
        ...
        if (item) {
                ...
                <>
                    ...
                    <div className='col py-3 markf'>
                        ...
                        <div className='d-flex'>
                            ...
                            <button className='btn btn-danger mx-3' onClick={removeOfCart}> <i className="fa-solid fa-trash-can"></i></button>
                        </div>
                    </div>
            ...
            return (
                <>
                    <h2 className='markf'>Количката е празна. <i className="fa-regular fa-face-angry pink"></i></h2>
                </>
            );
        }
    };
    ...
    return (
        <div>
            ...
            <div id='orderForm' className={`container orderForm py-5 my-5 ${showOrderForm ? 'd-flex justify-content-center' : 'd-none'}`}>
                <button className='btn btn-danger posbtn' onClick={toggleOrderFormVisibility}>
                ...
                <form className='w-75 text-light text-center'>
                    ...
                    <hr />
                    <div className="mb-3">
                        <h4 className='markf'>{count}x <img src={box2} height='40' alt="Product" /> Manicure Cards Challenge</h4>
                    </div>
